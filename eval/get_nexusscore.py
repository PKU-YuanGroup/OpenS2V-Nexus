...
def parse_args():
    ...
    parser.add_argument(
        "--output_json_file",
        type=str,
        default="demo_result/model_name_output_json/nexusscore.json",
    )
    parser.add_argument(
        "--model_config",
...
if __name__ == "__main__":
    ...
    for video_file in video_files:
        try:
            ...
            for bbox_conf, text_conf, retrieval_score in zip(
                all_yolo_world_conf, gme_text_score, gme_image_score
            ):
                if bbox_conf > 0.6 and text_conf > 0.30 and retrieval_score != 0:
                    retrieval_score_list.append(retrieval_score)
