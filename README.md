...
- [OmniShow](https://correr-zhou.github.io/OmniShow/), the first all-in-one model for human-object interaction video generation, unifying text, reference images, audio, and pose conditions into one model for multimodal controllable generative modeling. It supports R2V, A2V, RA2V, RP2V, and RAP2V tasks within one coherent framework, and also exhibits remarkable versatility in broader applications, such as audio-driven avatars, object swapping, and video remixing.
